...
<Tabs items={['From the monorepo','As a fresh project']}>
<Tab value="From the monorepo">
...
- Plug in a real OOBI handshake following [Tutorial 1](/guides/tutorials/link-agent-to-aid).
- Add signature verification for incoming A2A messages following [Tutorial 2](/guides/tutorials/verify-vc-a2a).
