...
<CardGroup cols={2}>
  <Card title="Tutorial 2 · Verify a VC in A2A" icon="shield-check" href="/tutorials/verify-vc-a2a">
    Now that your agent holds a credential, the next tutorial shows another
    agent how to verify it during an A2A interaction.
  </Card>
  <Card title="API Reference" icon="book" href="/api-reference/masumi-identity">
