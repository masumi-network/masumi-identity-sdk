...
This tutorial is the counterpart to [Tutorial 1](/tutorials/link-agent-to-aid). There, Agent A bound itself to an AID and received a Masumi credential. Here, Agent B decides whether to trust Agent A when they meet for the first time.
...
<Check>You've read [Core Concepts](/concepts) — especially the A2A flow.</Check>
