...
<CardGroup cols={2}>
  <Card title="Link an agent to an identity" icon="link" href="/tutorials/link-agent-to-aid">
    Bind any Masumi agent to a KERI AID backed by a Veridian wallet, so its identity is decentralized and user-owned.
  </Card>
  <Card title="Issue & hold Verifiable Credentials" icon="id-card" href="/api-reference/credentials">
    Issue ACDC credentials to an AID, fetch credentials an AID already holds, and validate issuance / revocation / expiration.
  </Card>
  <Card title="Verify signatures in A2A" icon="shield-check" href="/tutorials/verify-vc-a2a">
    Prove another agent owns the AID it claims before trusting a message, payment, or credential presentation.
  </Card>
  <Card title="Point at any KERI infrastructure" icon="server" href="/api-reference/constants">
