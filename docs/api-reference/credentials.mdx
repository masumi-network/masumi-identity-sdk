...
## `validateCredential` <Tooltip tip="Pure — no network call">🔒 pure</Tooltip>
...
## `formatCredential` <Tooltip tip="Pure — no network call">🔒 pure</Tooltip>
...
## `findCredentialBySchema` <Tooltip tip="Pure — no network call">🔒 pure</Tooltip>
